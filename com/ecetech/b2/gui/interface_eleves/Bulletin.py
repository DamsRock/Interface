...
def window_bulletin(id):
    ...
    def xml_read():
        ...
        def enregistrer():
            ...
            pdf.drawString(1.5*cm,25*cm,'Matières')
            pdf.line(4*cm,26*cm,4*cm,10*cm)
            pdf.drawString(4.3*cm,25*cm, 'Coeff')
            pdf.line(5.75*cm,26*cm,5.75*cm,10*cm)
            pdf.drawString(6.05*cm,25*cm, 'Moyenne élèves')
            pdf.line(9.95*cm,26*cm,9.95*cm,10*cm)
            pdf.drawString(10.2*cm,25*cm,'Moyenne classe')
            pdf.line(14*cm,26*cm,14*cm,10*cm)
            pdf.drawString(14.2*cm,25*cm,'Validation/Rattrapage')
            pdf.line(19.2*cm,26*cm,19.2*cm,10*cm)
            pdf.drawString(19.5*cm,25*cm, 'ECTS')

            pdf.line(0.9*cm,26*cm,0.9*cm,10*cm)
            pdf.line(0*cm,24.7*cm,23*cm,24.7*cm)
            pdf.drawString(0.3*cm,24.3*cm,'M')
            pdf.drawString(0.3*cm,23.9*cm,'O')
            pdf.drawString(0.3*cm,23.4*cm,'D')
            pdf.drawString(0.3*cm,22.9*cm,'U')
            pdf.drawString(0.3*cm,22.4*cm,'L')
            pdf.drawString(0.3*cm,21.9*cm,'E')
            pdf.drawString(0.3*cm,21.2*cm,'1')

            pdf.line(0*cm,19*cm,23*cm,19*cm)
            pdf.drawString(0.3*cm,18.6*cm,'M')
            pdf.drawString(0.3*cm,18.2*cm,'O')
            pdf.drawString(0.3*cm,17.75*cm,'D')
            pdf.drawString(0.3*cm,17.3*cm,'U')
            pdf.drawString(0.3*cm,16.9*cm,'L')
            pdf.drawString(0.3*cm,16.4*cm,'E')
            pdf.drawString(0.3*cm,15.8*cm,'2')

            pdf.line(0*cm,14*cm,23*cm,14*cm)
            pdf.drawString(0.3*cm,13.6*cm,'M')
            pdf.drawString(0.3*cm,13.2*cm,'O')
            pdf.drawString(0.3*cm,12.75*cm,'D')
            pdf.drawString(0.3*cm,12.3*cm,'U')
            pdf.drawString(0.3*cm,11.9*cm,'L')
            pdf.drawString(0.3*cm,11.4*cm,'E')
            pdf.drawString(0.3*cm,10.8*cm,'3')
